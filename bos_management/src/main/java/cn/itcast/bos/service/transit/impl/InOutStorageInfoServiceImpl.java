...
public class InOutStorageInfoServiceImpl implements InOutStorageInfoService {
	...
	@Autowired
	private TransitInfoRepository transientInfoRepository;
	...
	public void save(String transitInfoId, InOutStorageInfo inOutStorageInfo) {
		...
		System.out.println(transitInfoId+"......");
		//查询TransitInfo
		TransitInfo transitInfo = transientInfoRepository.findOne(Integer.parseInt(transitInfoId));
